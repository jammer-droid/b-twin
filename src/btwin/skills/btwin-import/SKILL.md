...
|---|-----------|------|------|------|
| 1 | library/smalltalk.md (섹션 260226) | 2026-02-26 | career-direction-update | career, ea-korea, ta |
| 2 | jobs/AdeccoKorea/00_report_260224.md | 2026-02-24 | ea-jd-analysis | interview, ea-korea, job-prep |
| ... | ... | ... | ... | ... |
```
...
- `date`: YYYY-MM-DD
- `slug`: 판단한 slug
- `tags`: 쉼표 구분 태그 문자열 (예: `"interview,ea-korea,job-prep"`)
